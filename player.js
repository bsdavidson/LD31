(function() {
  ...
  LD.Player.prototype = {
    create: function() {
      this.player = this.game.add.sprite(90, this.game.world.height - 32,
        'brian_ani');
    ...
    update: function() {
      ...
      this.game.physics.arcade.overlap(this.baseball, this.fanTop, function() {
        ...
        this.game.physics.arcade.moveToXY(this.baseball, 500,
          this.player.x + 400, this.player.y + 100, 750);
      }, null, this);

      // The Bug hit the fan.
      this.game.physics.arcade.overlap(this.bug, this.fanTop, function() {
        this.bug.health -= 10;
        this.game.physics.arcade.moveToXY(this.bug, 500, this.player.x + 400,
          this.player.y + 100, 750);
      }, null, this);
      ...
      if (baseballDistance < 90 && !this.bug.flying) {
        ...
        this.game.physics.arcade.moveToXY(
          this.bug, 500, this.player.x * 2, this.player.y * 2, 750);
      }
